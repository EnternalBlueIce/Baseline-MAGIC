...
from utils.loaddata import load_batch_level_dataset, load_metadata, \
    preload_entity_level_dataset,load_entity_level_dataset,\
    darpa_load_entity_level_dataset,darpa_load_metadata,\
...
def main(main_args):
    ...
    if dataset_name == 'streamspot' or dataset_name == 'wget':
        ...
        torch.save(model.state_dict(), "./checkpoints/checkpoint-{}.pt".format(safe_name))
        save_dict_path = './eval_result/distance_save_{}.pkl'.format(safe_name)
